...
AREA: Dict[str, Area] = {
    "Safari Counter":
    Area("Safari Counter", "This the Safari Counter where you can buy items",
    ...
    "Useless River":
    Area("Useless River", "Home to useless Pokemon",
         ["Kyoger Falls", "Great Pond"]),
    "Great Pond":
    Area(
        "Great Pond",
    ...
    "Upstairs":
    Area(
        "Upstairs", """You go upstairs and to your surprise...
...
Grasslands = [
    Pokemon("Oddish", "Grass", 29, 29, 0, False, ["Razor Leaf", "Tackle"],
            [random.randint(15, 20),
             random.randint(10, 20)]),
    Pokemon("Tailow", "Normal", 20, 20, 0, False, ["Peck", "Wing Attack"],
            [random.randint(15, 25),
             random.randint(30, 35)]),
    Pokemon("Bellsprout", "Grass", 30, 30, 0, False, ["Acid", "Bullet Speed"],
            [random.randint(15, 25),
             random.randint(10, 20)]),
    Pokemon("Pidgey", "Flying", 20, 20, 0, False, ["Areal Ace", "Air Cutter"],
            [random.randint(40, 50),
             random.randint(45, 55)])
]

Forest = [
    Pokemon("Weedle", "Bug", 25, 25, 0, False, ["Poison Sting", "Tackle"],
            [random.randint(25, 35),
             random.randint(10, 20)]),
    Pokemon("Wurmple", "Bug", 30, 30, 0, False, ["Poison Sting", "Tackle"],
            [random.randint(15, 25),
             random.randint(10, 20)]),
    Pokemon("Phantump", "Ghost", 35, 35, 0, False,
            ["Shadow Ball", "Shadow Claw"],
            [random.randint(20, 25),
             random.randint(25, 30)]),
    Pokemon("Ekans", "Poison", 30, 30, 0, False, ["Acid", "Beat Up"],
            [random.randint(30, 40),
             random.randint(10, 20)])
]

River = [
    Pokemon("Electrike", "Electric", 35, 35, 0, False, ["Tackle", "Shockwave"],
            [random.randint(10, 20),
             random.randint(20, 30)]),
    Pokemon("Magikarp", "Water", 15, 15, 0, False, ["Splash", "Better Splash"],
            [0, 0]),
    Pokemon("Spheal", "Water", 35, 35, 0, False, ["Rollout", "Water Gun"],
            [random.randint(20, 30),
             random.randint(25, 35)]),
    Pokemon("Dratini", "Dragon", 40, 40, 0, False, ["Dragon Rage", "Spark"],
            [random.randint(15, 20),
             random.randint(25, 30)])
]

Dessert = [
    Pokemon("Cubone", "Ground", 20, 20, 0, False, ["Mud-Slap", "Boomerang"],
            [random.randint(15, 25)]),
    Pokemon("Onix", "Rock", 35, 35, 0, False, ["Tackle", "Sand Tomb"],
            [random.randint(10, 20),
             random.randint(35, 45)]),
    Pokemon("Gible", "Dragon", 30, 30, 0, False, ["Sand Tomb", "Tackle"],
            [random.randint(25, 35),
             random.randint(10, 20)]),
    Pokemon("Ponyta", "Fire", 35, 35, 0, False, ["Tackle", "Tail Whip"],
            [random.randint(10, 20),
             random.randint(25, 35)])
]

Mountain = [
    Pokemon("Machop", "Fighting", 45, 45, 0, False, ["Revenge", "Low Sweep"],
            [random.randint(45, 50)]),
    Pokemon("Beldum", "Steel", 35, 35, 0, False, ["Iron Head", "Tackle"],
            [random.randint(45, 55),
             random.randint(10, 20)]),
    Pokemon("Vanillite", "Ice", 30, 30, 0, False, ["Icy Wind", "Avalanche"],
            [random.randint(45, 55),
             random.randint(50, 60)]),
    Pokemon("Mankey", "Fighting", 40, 40, 0, False, ["Scratch", "Karate Chop"],
            [random.randint(30, 40),
             random.randint(40, 50)])
]

Haunted_house = [
    Pokemon("Duskull", "Ghost", 20, 20, 0, False, ["Astonish", "Pursuit"],
            [random.randint(20, 30),
             random.randint(30, 40)]),
    Pokemon("Pinsir", "Bug", 60, 60, 0, False, ["Body Slam", "Brick Break"],
            [random.randint(50, 60),
             random.randint(60, 70)]),
    Pokemon("Ralts", "Psychic", 30, 30, 0, False, ["Body Slam", "Double Edge"],
            [random.randint(50, 60),
             random.randint(60, 70)]),
    Pokemon("Absol", "Dark", 65, 65, 0, False, ["Bite", "Cut"],
            [random.randint(50, 60),
             random.randint(40, 50)])
]


def encounter(player: Player, location: Dict[str, Area]) -> None:
    if location == AREA["Grasslands"] or location == AREA[
            "Prairie"] or location == AREA["Pampas"] or location == AREA[
                "Savanna"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
        elif start == 2 or start == 3 or start == 4:
            wild_poke = catch(player, location)
            print(f"The wild {wild_poke.name} appears.")
            encounter_options(player, wild_poke)
    elif location == AREA["PC"]:
        PC_actions(player, location)
    elif location == AREA["Battle Counter"]:
        battlecounter_options(player, location)
    if location == AREA["The Forest Opening"] or location == AREA[
            "Temperate"] or location == AREA["Boreal"] or location == AREA[
                "Tropical"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
            ...
            print(f"The wild {wild_poke.name} appears.")
            encounter_options(player, wild_poke)
    if location == AREA["Kyoger Falls"] or location == AREA[
            "Useless River"] or location == AREA["Great Pond"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
        elif start == 2 or start == 3 or start == 4:
            ...
            print(f"The wild {wild_poke.name} appears.")
            encounter_options(player, wild_poke)
    if location == AREA["Poke Beach"] or location == AREA[
            "Dust Bowl"] or location == AREA["Addax"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
        elif start == 2 or start == 3 or start == 4:
            ...
            print(f"The wild {wild_poke.name} appears.")
            encounter_options(player, wild_poke)
    if location == AREA["Base"] or location == AREA[
            "Regice Line"] or location == AREA["Peak"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
        elif start == 2 or start == 3 or start == 4:
            ...
            print(f"The wild {wild_poke.name} appears.")
            encounter_options(player, wild_poke)
    if location == AREA["Haunted House"] or location == AREA[
            "Lobby"] or location == AREA["Upstairs"] or location == AREA[
                "Attic"]:
        start = random.randint(1, 4)
        if start == 1:
            pass
    ...
    if location == AREA["Safari Counter"]:
        store(player)


def Giratina(player: Player, location: Dict[str, Area]) -> None:
    print(
        "The box opens up and sucked you inside. All you could see was just blue and purple everywhere. You realize that the fairy tail of the Distortion World was true. Then, an humongus looking Pokemon appears out of thin air. It is the legendary Pokemon named Giratina, and it does NOT look happy!"
    )
    Distortion = Pokemon("Giratina", "Ghost", 300, 300, 0, False,
                         ["Shadow Force", "Hex"],
                         [random.randint(60, 70),
                          random.randint(90, 100)])
    print(f"{Distortion.name} wants to battle!")
    in_battle = player.party[0]
    print(f"{player.name} sends out {in_battle.name}")
    battle(Distortion, player, location)
    if Distortion.fainted == True:
        print("Congragulations!  You have a chance to Catch this Pokemon!")
        catch_giratina(player, Distortion)


def catch_giratina(player: Player, Distortion: Pokemon) -> None:
    attempt = random.randint(2, 10)
    while True:
        attempts = 0
        if attempts < attempt:
            ...
            action = input("> ")
            if action == "Run":
                print("You cannot run away from a Legendary")
            elif action == "Catch":
                print(player.items)
                ...
                if pokeball == "Pokeball" and "Pokeball" in player.items:
                    ...
                    if catch_rate in range(1, 10):
                        player.party.append(Distortion)
                        print(f"You caught the wild {Distortion.name}")
                        break
                    else:
                        attempts = attempts + 1
                        print(f"The wild {Distortion.name} broke out")
                elif pokeball == "Greatball" and "Greatball" in player.items:
                    player.items.remove("Greatball")
                    catch_rate = random.randint(1, 100)
                    if catch_rate in range(1, 30):
                        player.party.append(Distortion)
                        print(f"You caught the wild {Distortion.name}")
                        break
                    else:
                ...
                print(
                    "You have no time to be dumb, please catch it before you loose it!"
                )
        else:
            print(f"The {Distortion.name} ran away!")
            break


def encounter_options(player: Player, wild_poke: Pokemon) -> None:
    while True:
        attempts = 0
        if attempts < 5:
            print("What will you do?\nCatch\nRun")
            ...
            if action == "Run":
                ...
                print(
                    "You have no time to be dumb, please run away or catch it!"
                )
        else:
...
def catch(player: Player, location: Dict[str, Area]) -> Pokemon:
    if location == AREA["Grasslands"] or location == AREA[
            "Prairie"] or location == AREA["Pampas"] or location == AREA[
                "Savanna"]:
        ...
        return wild_poke
    elif location == AREA["The Forest Opening"] or location == AREA[
            "Temperate"] or location == AREA["Boreal"] or location == AREA[
                "Tropical"]:
        num = random.randint(0, 3)
        wild_poke = Forest[num]
        return wild_poke
    elif location == AREA["Kyoger Falls"] or location == AREA[
            "Useless River"] or location == AREA["Great Pond"]:
        num = random.randint(0, 3)
        wild_poke = River[num]
        return wild_poke
    elif location == AREA["Poke Beach"] or location == AREA[
            "Dust Bowl"] or location == AREA["Addax"]:
        num = random.randint(0, 3)
        wild_poke = Dessert[num]
        return wild_poke
    elif location == AREA["Base"] or location == AREA[
            "Regice Line"] or location == AREA["Peak"]:
        num = random.randint(0, 3)
        wild_poke = Mountain[num]
        return wild_poke
    elif location == AREA["Haunted House"] or location == AREA[
            "Lobby"] or location == AREA["Upstairs"] or location == AREA[
                "Attic"]:
        num = random.randint(0, 3)
...
def PC_actions(player: Player, location: Dict[str, Area]) -> None:
    PC_list: List[Pokemon] = []
    while True:
        if location == AREA["PC"]:
            ...
            if action == "N":
                ...
                print("Deposit, Withdraw, or Heal")
                action = input("> ")
...
def store(player: Player) -> None:
    while True:
        print(
            "What would you like to buy? or q to quit?\nPokeball\nGreatball\nUltraball\nMasterball"
        )
        action = input("> ")
        if action == "Pokeball" and player.money >= 100:
            ...
            print("Please select a vaild Pokeball or get more money.")


def battlecounter_options(player: Player, location: Dict[str, Area]) -> None:
    if location == AREA["Battle Counter"]:
        while True:
            print(
                "Welcome to the Battle Counter! What Tower would you like tobattle? or press q to quit.\nBronze\nSilver\nGold"
            )
            action = input("> ")
            if action == "Bronze":
...
def bronze_tower(player: Player, location: Dict[str, Area]) -> None:
    ...
    while True:
        if Grasslands[2].fainted == False:
            battle(Grasslands[2], player, location)
            if Forest[3].fainted == False:
                battle(Forest[3], player, location)
                if Grasslands[0].fainted == False:
                    battle(Grasslands[0], player, location)
                    if Mountain[3].fainted == False:
                        battle(Mountain[3], player, location)
                        if Haunted_house[1].fainted == False:
                            ...
                            Haunted_house[0].health += Haunted_house[
                                0].health_cap
                            print("Bronze Champion Jacen has been defeated!")
                            player.money += (1000)
                            player.items.append("Bronze Medal")
                            print(
                                "For your outstanding battle skills you obtained the Bronze Medal"
                            )
                            break
...
def silver_tower(player: Player, location: Dict[str, Area]) -> None:
    ...
    while True:
        if Grasslands[3].fainted == False:
            battle(Grasslands[3], player, location)
            break
        if Forest[0].fainted == False:
            battle(Forest[0], player, location)
            break
        if Grasslands[1].fainted == False:
            battle(Grasslands[1], player, location)
            break
        if Dessert[3].fainted == False:
            battle(Dessert[3], player, location)
            break
        if Haunted_house[2].fainted == False:
            battle(Haunted_house[2], player, location)
            break
        else:
            ...
            print(
                "For your outstanding battle skills you obtained the Silver Medal"
            )
            break
...
def gold_tower(player: Player, location: Dict[str, Area]) -> None:
    ...
    while True:
        if Dessert[2].fainted == False:
            battle(Dessert[2], player, location)
            break
        if Mountain[3].fainted == False:
            battle(Mountain[3], player, location)
            break
        ...
        if Dessert[0].fainted == False:
            battle(Dessert[0], player, location)
            break
        else:
            ...
            print(
                "For your outstanding battle skills you obtained the Gold Medal"
            )
...
def battle(pokemon: Pokemon, player: Player, location: Dict[str, Area]):
    ...
    while True:
        if in_battle.health > 0:
            ...
            print(
                f"{in_battle.name}: {in_battle.health_cap}/{in_battle.health}")
            ...
            if action == move:
                ...
                if pokemon.health > 0:
                    trainer_choice = random.randint(1, len(pokemon.moves))
                    trainer_choice = trainer_choice - 1
                    print(
                        f"{pokemon.name} used {pokemon.moves[trainer_choice]}")
                    in_battle.health = in_battle.health - pokemon.damage[
                        trainer_choice]
        ...
        elif in_battle.health <= 0:
            if all(player.party.fainted):
                white_out(location, player)
                break
            else:
...
def switch(in_battle: Pokemon, player: Player) -> Pokemon:
    while True:
        ...
        for pokemon in player.party:
            if pokemon != in_battle and pokemon.fainted == False:
                print(pokemon.name)
        switch = input("> ")
        if switch == pokemon.name:
            ...
            print("Please give a vaild pokemon")


def white_out(location: Dict[str, Area], player: Player) -> None:

    print("You lost....You whited out!")
    ...
    Haunted_house[0].health += Haunted_house[0].health_cap
    while True:
        print("Do you want to go back to the Safari Counter, or quit?")
        restart = input("> ")
        if restart == "Safari Counter":
...
def area_movement(player: Player, location: Dict[str, Area]) -> str:
    while True:
...
def pick_starter(player: Player) -> None:
    while True:
        print(
            f"Hello, {player.name} welcome to the newly opened Safari Park, please select a starter."
        )
        print("Treecko, Mudkip or Torchic?")
        starter = input("> ")
        if starter == "Treecko":
            player.party.append(
                Pokemon("Treecko", "Grass", 35, 35, 0, False,
                        ["Pound", "Absorb"],
                        [random.randint(15, 20),
                         random.randint(25, 26)]))
            print("You got the grass type Pokemon Treecko!")
            break
        elif starter == "Mudkip":
            player.party.append(
                Pokemon("Mudkip", "Water", 45, 45, 0, False,
                        ["Tackle", "Water Gun"],
                        [random.randint(10, 20),
                         random.randint(25, 30)]))
            ...
            player.party.append(
                Pokemon("Torchic", "Fire", 30, 30, 0, False,
                        ["Scratch", "Ember"],
                        [random.randint(15, 20),
            ...
            player.party.append(
                Pokemon("Magikarp", "Water", 15, 15, 0, False,
                        ["Splash", "Better Splash"], [0, 0]))
            print("You got a Magicarp! Ha Ha Ha!")
            break
            Pokemon("Magikarp", "Water", 15, 15, 0, False,
                    ["Splash", "Better Splash"], [0, 0])
...
def main() -> None:
    ...
    while True:
        ...
        print(location.connections)
        print("Where would you like to go?")
        location = area_movement(player, location)
